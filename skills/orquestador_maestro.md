...
2. ¿Pide una infografía, diapositivas o algo visual? → Delega a `artes_diseno/disenador_grafico.md` (Director de Arte).
...
| `artes_diseno` | `disenador_grafico.md` | `modulos/artes_diseno/scripts/motor_pptx_visual.py` |
